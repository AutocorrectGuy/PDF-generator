...
export const dndPanelStyles = {
  ...
  dropdowns: {
    list: {
      ...
      menuItemClass: "flex items-center justify-start text-neutral-400 px-2 h-10 relative cursor-pointer hover:text-white select-none whitespace-nowrap",
  ...
  searchBar: {
    ...
    searchBarInputContainer: "relative flex min-w-[1px] max-w-[450px] flex-grow items-center h-10 bg-neutral-700 rounded-sm shadow-sm shadow-neutral-800 active:shadow-none",
    sarchBarBtnKatalogs: "flex items-center justify-center w-6 h-10 bg-neutral-700 rounded-sm hover:bg-[#464646] active:bg-neutral-800",
